    <main>
        <div class="container-fluid px-4">
            ...
            <a href="<?php echo base_url('management/forums/store') ?>" class="btn btn-success">Tambah</a>
            <div class="card mb-4">
                        ...
                        <tbody>
                            <?php foreach ($forums as $data) : ?>
                                <tr>
                                    ...
                                    <td><a href="<?php echo base_url("game/forum/").$data["game_id"] ?>">Link</a></td>
                                    <td>
                                        <a href="<?php echo base_url('management/forums/delete/').$data['id'] ?>" onclick="return confirm('Yakin ingin dihapus')">
